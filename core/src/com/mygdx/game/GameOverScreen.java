...
public class GameOverScreen extends AbstractScreen {//Отвечает за окно поражения в игре
    ...
    public GameOverScreen(SpriteBatch batch) {
        ...
        backGroundImage = new Texture("lose.jpg");
    }
    ...
    public void render(float dt) {
        ...
        font.draw(batch, "Game Over", 0, 500, 1280, 1, false);
